...
st.title("Parte 1")
st.header("Aca podes apreciar algunas preguntas que coloque por ej algunos nombres de productos que podes encontrar en el dataset los precios que tiene tambien podes encontrar los horarios que hay en las provincias")
